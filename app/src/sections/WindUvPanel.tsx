      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="glass-panel">
          ...
          <div className="flex flex-col items-center mt-4">
            ...
            <p className="text-heading-large font-light text-charcoal mt-4">{current.windSpeed} mph</p>
            <p className="text-body-small text-warm-gray mt-1">Gusts up to 22 mph</p>
          </div>
        </div>
